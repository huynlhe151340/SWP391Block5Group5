 ...
 * @author ADMIN
 */
@WebFilter(filterName = "JSPPageFilter", urlPatterns = {"/*"})
public class JSPPageFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("JSPPageFilter:DoBeforeProcessing");
        }
	...
	for (Enumeration en = request.getParameterNames(); en.hasMoreElements(); ) {
        ...
        accounts currentAccount = (accounts) httpRequest.getSession().getAttribute("currentAccount");
...
//                httpResponse.sendRedirect("lesson-view.jsp");
//                return;
//            }
//            httpResponse.sendRedirect("user/index.jsp");
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("JSPPageFilter:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("JSPPageFilter:Initializing filter");
            }
        }
    }
