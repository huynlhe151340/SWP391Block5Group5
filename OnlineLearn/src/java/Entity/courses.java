...
public class courses {
    ...
    public String toString() {
        return "courses{" + "id=" + id + ", name=" + name + ", price=" + price + ", description=" + description + ", image=" + image + ", note=" + note + ", status=" + status + ", lectures=" + lectures + ", duration=" + duration + ", skillLevel=" + skillLevel + ", language=" + language + ", teacerID=" + teacerID + '}';
    }
