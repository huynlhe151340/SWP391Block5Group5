    ...
    <body id="bg">
        <div class="page-wraper">
            ...
            <header class="header rs-nav header-transparent">
                <div class="top-bar">
                    <div class="container">
                        <div class="row d-flex justify-content-between" style="justify-content: space-between">
...
<!--                                    <li><a href="javascript:;">Pages <i class="fa fa-chevron-down"></i></a>
                                    ...
                                    <li class="add-mega-menu"><a href="courses">Courses</a>
...
<!--                                    <div class="tp-caption Newspaper-Button rev-btn " id="slide-100-layer-5"
                                         ...
                                         style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; background-color: #4c1864 !important; border:0; border-radius:30px; margin-right:5px;">
                                        READ MORE </div>
