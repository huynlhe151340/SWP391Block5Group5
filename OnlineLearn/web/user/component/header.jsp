                    ...
                    <div class="topbar-right">
                        <ul>
                            ...
                            <c:if test="${not empty currentAccount}">
                                <li>Welcome ${currentAccount.accountDetail.name}</li>
            ...
            <div class="menu-bar clearfix">
                <div class="container clearfix">
                    ...
                    <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
                        <div class="menu-logo">
                            <a href="index.html"><img src="${pageContext.request.contextPath}/user/assets/images/logo.png" alt=""></a>
                        </div>
                        <ul class="nav navbar-nav">
                            ...
                            <li class="add-mega-menu"><a href="javascript:;">Our Courses <i
                                ...
                                <ul class="sub-menu add-menu">
                                    ...
                                    <li class="add-menu-right">
                                        <img src="${pageContext.request.contextPath}/user/assets/images/adv/adv.jpg" alt="" />
                                    </li>
                                </ul>
                            </li>
                            ...
                            <c:if test="${currentAccount.roleID == 1}">
