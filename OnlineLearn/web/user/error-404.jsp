<%-- 
    Document   : error
    Created on : Apr 12, 2022, 11:42:37 PM
    Author     : khait
--%>
        ...
        <div class="page-wraper">
            ...
            <div class="account-form">
                <div class="account-head" style="background-image:url(${pageContext.request.contextPath}/user/assets/images/background/bg2.jpg);">
                    <a href="index.jsp"><img src="${pageContext.request.contextPath}/user/assets/images/logo-white-2.png" alt=""></a>
                </div>
                <div class="account-form-inner">
                    <div class="account-container">
                        <div class="error-page">
                            ...
                            <div class="">
                                <a href="${pageContext.request.contextPath}/user/index.jsp" class="btn m-r5">Preview</a>
                                <a href="${pageContext.request.contextPath}/user/index.jsp" class="btn outline black">Back To Home</a>
                            </div>
                        </div>
                    </div>
                </div>
