<%-- 
    Document   : register
    Created on : Apr 16, 2022, 5:06:17 PM
    Author     : khait
--%>
                        ...
                        <form class="contact-bx" action="register" method="POST">
                            <div class="row placeani">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <!--                                        <div class="input-group">
                                                                                    <label>Your Gender</label><input type="radio" name="mobile" value="" />
                                                                                    <input name="gender" type="radio" value="0">Male <input name="gender" type="radio" value="1">Female
                                                                                </div>-->
