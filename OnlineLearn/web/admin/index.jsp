<%-- 
    Document   : index
    Created on : Apr 19, 2022, 7:59:32 PM
    Author     : ADMIN
--%>
                            ...
                            <div class="widget-box">
                                ...
                                <div class="widget-inner">
                                    <div class="new-user-list">
                                        <ul>
                                            <li>
                                                <span class="new-users-pic">
                                                    <img src="${pageContext.request.contextPath}/admin/assets/images/testimonials/pic1.jpg" alt=""/>
                                            </span>
                                        ...
                                        <li>
                                            <span class="new-users-pic">
                                                <img src="${pageContext.request.contextPath}/admin/assets/images/testimonials/pic2.jpg" alt=""/>
                                            </span>
                                            <span class="new-users-text">
